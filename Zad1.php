...
<BODY>
	...
	<div id="sredina">
	<form id='srcforma' action='Zad1.php' method='POST'>
	<div id="dugmad">
	<button type="submit" action="Zad1.php" name="baton1"> Sortiraj po datumu </button>
	</div>
	<div i="dugmad1">
	<button type="submit" action="Zad1.php" name="baton2"> Sortiraj po abecedi </button>
	</form>
	</id>
	<div class="Novosti1">
